...
def get_stored_ticket(id):
	'''Retrieves the ticket with the given ID from the CSV file.'''
	pass

def delete_stored_ticket(id):
	'''Deletes the ticket with the given ID from the CSV file.'''
	pass
